...
namespace DataAccess
{
    public sealed class DbHelp
    {
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public static IEnumerable<T> QueryMultiple<T>(string sql, out int totalCount, object param = null)
        {
            using (IDbConnection con = DbConnectionFactory.Instance.GetOpenConnection())
            {
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public static int Execute(IEnumerable<string> sqlList, object param = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            using (IDbConnection con = DbConnectionFactory.Instance.GetOpenConnection())
            {
                con.Open();
                ...
                {
                    row += con.Execute(@sql, param, trans, commandTimeout, commandType);
                }
